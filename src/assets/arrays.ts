...
export const transformatorMerkeziArray = [
  'İŞLETMEDE',
  'TESİS AŞAMASINDA',
  'PLANLAMADA',
];
export const transformatorMerkeziTipiArray = [
  'KLASİK',
  'GİS (GAZ İZOLELİ SİSTEM)',
  'SKM (SERİ KAPASİTÖR MERKEZİ)',
  'İNTERFACE',
];
export const mulkiyetArray = ['TEİAŞ', 'ORTAK', 'DİĞER', 'YURTDIŞI'];
export const isletenFirmaArray = [
...
export const maksimumSaltArray = [
  '6.3',
  '10.5',
  '15.8',
  '33',
